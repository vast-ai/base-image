...
HF_MODELS=(
    ...
    |$MODELS_DIR/diffusion_models/lotus-depth-d-v1-1.safetensors"
    ...
    |$MODELS_DIR/loras/ltx-2-19b-ic-lora-depth-control.safetensors"
...
WGET_DOWNLOADS=(
    "https://substack-post-media.s3.amazonaws.com/public/images/3c622277-1c11-465a-a65d-2ba8a0203d7e_1344x896.png
    |$INPUTS_DIR/freckled_curly_girl.png"
    "https://substack-post-media.s3.amazonaws.com/public/images/8b9ae273-3a04-4f5f-879d-a5519378363e_1344x896.png
    |$INPUTS_DIR/snow_bike_jump_crew.png"
)
### End Configuration ###
    ...
    "subgraphs": [
      {
        ...
        "inputs": [
          {
            "id": "783f39cb-e014-4f49-bc6e-86ded9abaf13",
            "name": "width",
            "type": "INT",
            "linkIds": [
              253
          ...
          {
            "id": "bf33a932-80f8-4bf3-b1a1-ac474fc81d62",
            "name": "height",
            "type": "INT",
            "linkIds": [
              254
          ...
          {
            "id": "43a67b8d-9ca1-41f8-92ab-ba654ad3287e",
            "name": "noise_seed",
            "type": "INT",
            "linkIds": [
              256
          ...
          {
            "id": "df42f7c0-3722-437e-8a24-3c0864b78bc0",
            "name": "ckpt_name",
            "type": "COMBO",
            "linkIds": [
              279,
