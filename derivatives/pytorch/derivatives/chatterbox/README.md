...
Vast PyTorch base. The server is installed at `$WORKSPACE/chatterbox` and started via
...
- **Models** download on first synthesis into `$WORKSPACE/chatterbox/model_cache` (nothing is
