...
/usr/bin/x11vnc --storepasswd ${VNC_PASSWORD:-$OPEN_BUTTON_TOKEN} ${XDG_RUNTIME_DIR}/.vncpasswd

/usr/bin/x11vnc -display ${DISPLAY} -forever -shared -rfbport 5900 -rfbauth ${XDG_RUNTIME_DIR}/.vncpasswd
