...
def render_summary(decisions: list[dict]) -> str:
    ...
    lines += [
        ...
        "  manifest was never booted. Deliberate and parked on market size (ADR 0019",
        "  cond 5): ~10 arm64 offers exist at these floors against ~744 amd64.",
        ...
        "  reached only by explicit dated reference. Also deliberate: no auto tag",
        "  means no automatic path to a customer.",
